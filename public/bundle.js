...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiGithub = __webpack_require__(220);

	var _apiGithub2 = _interopRequireDefault(_apiGithub);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiGitHub = {
	    getGithubInfo: function getGithubInfo(username) {
	        return Promise.all([getGithubRepos(username), getGithubUserInfo(username)]).then(function (values) {
	            return {
	                repos: values[0],
	                bio: values[1]
	            };
